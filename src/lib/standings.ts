import type { MatchTablePlayer, MatchTableMatch } from "@/types/events";
...
export const formatStandingPoints = (value: number) =>
  Number.isInteger(value) ? String(value) : value.toFixed(1);

export const formatStandingDiff = (value: number) =>
